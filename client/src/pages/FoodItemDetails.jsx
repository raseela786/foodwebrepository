...
const hoteldetails = async () => {
  try {
      ...
      toast.success('hoooooooooooooooooooooooooooooooooooooootel')
  ...
  return (
    <div className="flex flex-col md:flex-row items-center space-y-10 md:space-y-0 md:space-x-10 my-10 mx-5">
      {/* Food Details Section */}
      <div className="bg-white shadow-lg rounded-lg p-6 flex-1 max-w-lg">
        <h2 className="text-3xl font-semibold mb-4">{fooddetails.title}</h2>
  ...
  \
      ...
      <div className="bg-white shadow-lg rounded-lg p-6 flex-1 max-w-lg">
        <h3 className="text-2xl font-semibold mb-4">Hotel Details</h3>
        {hotelDetails ? (
          <>
            <h4 className="text-xl font-semibold mb-2">Name:{hotelDetails.name}</h4>
